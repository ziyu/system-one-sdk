import { denseArray, identifier, record } from '@system-one-ai/core/composition';
import { ConfigurationError, RequestAbortedError, ValidationError } from '@system-one-ai/core';
import { snapshotHeaders } from '@system-one-ai/core/http';
import type { EvaluateRequest, EvaluationClient, EvaluationResult, Questions, RequestOptions, Usage } from '@system-one-ai/core';
import { configInteger, snapshotRequest } from '@system-one-ai/core/validation';
