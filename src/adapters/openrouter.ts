...
/** Optional OpenRouter Decisions codec. Import from @system-one-ai/sdk/adapters/openrouter. */
export const openRouterAdapter: SystemOneAdapter = Object.freeze({
  ...
  decode(payload: unknown, context: AdapterContext) {
    ...
    const normalized = responseRecord(systemOneAdapter.decode(payload, context), 'response');
